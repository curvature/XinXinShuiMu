...
import net.newsmth.dirac.audio.AlbumArtCache;
...
public class FullScreenPlayerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPauseDrawable = ContextCompat.getDrawable(this, R.drawable.ic_pause_white_36dp);
        mPlayDrawable = ContextCompat.getDrawable(this, R.drawable.ic_play_arrow_white_36dp);
