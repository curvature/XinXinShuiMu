...
package net.newsmth.dirac.audio.utils;
...
import net.newsmth.dirac.audio.VoiceSearchParams;
import net.newsmth.dirac.audio.model.MusicProvider;

import java.util.ArrayList;
import java.util.List;

import static net.newsmth.dirac.audio.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
