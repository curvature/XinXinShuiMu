...
import net.newsmth.dirac.audio.utils.MediaIDHelper;
...
import static net.newsmth.dirac.audio.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static net.newsmth.dirac.audio.utils.MediaIDHelper.MEDIA_ID_ROOT;
import static net.newsmth.dirac.audio.utils.MediaIDHelper.createMediaID;
...
public class MusicProvider {
    ...
    public static final List<TextOrImage> mList = new ArrayList<>();
    private static final String TAG = LogHelper.makeLogTag(MusicProvider.class);
    static MusicProvider inst;
    ...
    public static void add(TextOrImage item) {
        if (!mList.contains(item)) {
            mList.add(item);
        }
        inst.mCurrentState = State.NON_INITIALIZED;
        inst.retrieveMedia();
    }
    ...
    public List<MediaMetadataCompat> getTrack() {

        List<MediaMetadataCompat> res = new ArrayList<>();

        for (TextOrImage item : mList) {
            res.add(RemoteJSONSource.build(item));
        }
    ...
    public synchronized void updateMusicDuration(String musicId, long duration) {
        MediaMetadataCompat metadata = getMusic(musicId);
        metadata = new MediaMetadataCompat.Builder(metadata)
    ...
    private MediaBrowserCompat.MediaItem createBrowsableMediaItemForRoot(Resources resources) {
        MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
                ...
                .setIconUri(Uri.parse("android.resource://" +
                        "net.newsmth.dirac.audio.uamp/drawable/ic_by_genre"))
                .build();
