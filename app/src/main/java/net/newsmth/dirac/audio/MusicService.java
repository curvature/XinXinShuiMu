...
import net.newsmth.dirac.audio.playback.LocalPlayback;
import net.newsmth.dirac.audio.playback.PlaybackManager;
import net.newsmth.dirac.audio.playback.QueueManager;
import net.newsmth.dirac.audio.ui.FullScreenPlayerActivity;
import net.newsmth.dirac.audio.utils.CarHelper;
import net.newsmth.dirac.audio.utils.LogHelper;
import net.newsmth.dirac.audio.utils.WearHelper;

import java.lang.ref.WeakReference;
import java.util.ArrayList;
import java.util.List;

import static net.newsmth.dirac.audio.utils.MediaIDHelper.MEDIA_ID_EMPTY_ROOT;
import static net.newsmth.dirac.audio.utils.MediaIDHelper.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "net.newsmth.dirac.audio.uamp.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "net.newsmth.dirac.audio.uamp.ACTION_CMD";
...
//  private SessionManagerListener<CastSession> mCastSessionManagerListener;
    ...
    public void onCreate() {
        ...
        LocalPlayback playback = new LocalPlayback(this, mMusicProvider, queueManager);
    ...
    public void onLoadChildren(@NonNull final String parentMediaId,
        ...
        if (MEDIA_ID_EMPTY_ROOT.equals(parentMediaId)) {
            ...
            mMusicProvider.retrieveMediaAsync(
                    success -> result.sendResult(mMusicProvider.getChildren(parentMediaId, getResources())));
        }
    }
