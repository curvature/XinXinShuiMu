...
import net.newsmth.dirac.audio.ui.MusicPlayerActivity;
import net.newsmth.dirac.audio.utils.LogHelper;
import net.newsmth.dirac.audio.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    public static final String ACTION_PAUSE = "net.newsmth.dirac.audio.uamp.pause";
    public static final String ACTION_PLAY = "net.newsmth.dirac.audio.uamp.play";
    public static final String ACTION_PREV = "net.newsmth.dirac.audio.uamp.prev";
    public static final String ACTION_NEXT = "net.newsmth.dirac.audio.uamp.next";
    public static final String ACTION_STOP = "net.newsmth.dirac.audio.uamp.stop";
    public static final String ACTION_STOP_CASTING = "net.newsmth.dirac.audio.uamp.stop_cast";
    private static final String TAG = LogHelper.makeLogTag(MediaNotificationManager.class);
    private static final String CHANNEL_ID = "net.newsmth.dirac.audio.AUDIO_CHANNEL_ID";
...
//                    R.drawable.ic_arrow_back_black_24dp); can't use vector drawable
            }
        }
        ...
        if (mNotificationManager.getNotificationChannel(CHANNEL_ID) == null) {
            NotificationChannel notificationChannel =
                    new NotificationChannel(CHANNEL_ID,
                            mService.getString(R.string.channel_audio_playback),
