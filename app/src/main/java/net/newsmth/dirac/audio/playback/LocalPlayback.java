 ...
 */
package net.newsmth.dirac.audio.playback;
...
import net.newsmth.dirac.audio.model.MusicProviderSource;
...
public final class LocalPlayback implements Playback {
    ...
    public LocalPlayback(Context context, MusicProvider musicProvider, QueueManager queueManager) {
            ...
            switch (playbackState) {
                case ExoPlayer.STATE_READY:
                    ...
                    if (duration != C.TIME_UNSET) {
                        mMusicProvider.updateMusicDuration(mCurrentMediaId, duration);
